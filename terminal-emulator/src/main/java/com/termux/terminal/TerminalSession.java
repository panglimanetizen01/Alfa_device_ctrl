...
public final class TerminalSession extends TerminalOutput {
    ...
    /** Callback which gets notified when the process finishes or changes title. */
     ...
     *               for communication between the session and its client.
     */
    ...
    public String getCwd() {
        ...
        try {
            ...
            if (!outputPath.endsWith("/")) outputPathWithTrailingSlash += '/';
            if (!cwdSymlink.equals(outputPathWithTrailingSlash)) return outputPath;
    ...
    @Override public void onCopyTextToClipboard(String text) { mClient.onCopyTextToClipboard(this, text); }
    @Override public void onPasteTextFromClipboard() { mClient.onPasteTextFromClipboard(this); }
    @Override public void onBell() { mClient.onBell(this); }
    @Override public void onColorsChanged() { mClient.onColorsChanged(this); }

    private static FileDescriptor wrapFileDescriptor(int fileDescriptor, TerminalSessionClient client) {
        FileDescriptor result = new FileDescriptor();
        try {
            Field descriptorField;
            try { descriptorField = FileDescriptor.class.getDeclaredField("descriptor"); }
            catch (NoSuchFieldException e) { descriptorField = FileDescriptor.class.getDeclaredField("fd"); }
