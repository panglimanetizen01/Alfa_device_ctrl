...
public final class AlfaApplication extends Application {
    ...
    @Override public void onCreate() {
        ...
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            @Override public void onActivityCreated(Activity activity, Bundle state) { installWindowMetricsAndInsetsPolicy(activity); AlfaUiTheme.apply(activity); AlfaFinalUiHooks.apply(activity); ExternalExecutionUiHooks.apply(activity); }
            @Override public void onActivityResumed(Activity activity) { AlfaUiTheme.apply(activity); AlfaFinalUiHooks.apply(activity); ExternalExecutionUiHooks.apply(activity); RuntimeStartupCoordinator.onActivityResumed(activity); }
