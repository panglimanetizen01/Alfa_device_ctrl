...
public final class AlfaApplication extends Application {
    ...
    @Override public void onCreate() {
        ...
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            @Override public void onActivityCreated(Activity activity, Bundle state) { installWindowMetricsAndInsetsPolicy(activity); AlfaUiTheme.apply(activity); AlfaFinalUiPresentation.apply(activity); AlfaFinalUiHooks.apply(activity); }
            @Override public void onActivityResumed(Activity activity) { AlfaUiTheme.apply(activity); AlfaFinalUiPresentation.apply(activity); AlfaFinalUiHooks.apply(activity); RuntimeStartupCoordinator.onActivityResumed(activity); }
