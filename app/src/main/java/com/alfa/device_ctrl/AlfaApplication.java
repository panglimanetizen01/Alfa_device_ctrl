...
public final class AlfaApplication extends Application {
    ...
    private static void installWindowInsetsPolicy(Activity activity) {
        ...
        final int baseLeft = content.getPaddingLeft(), baseTop = content.getPaddingTop(), baseRight = content.getPaddingRight(), baseBottom = content.getPaddingBottom();
    ...
    private static void validate(File file) throws Exception {
        ...
        require(p,"pipeline_run_id"); require(p,"runtime_id"); require(p,"source_commit"); require(p,"gate4_contract_sha256"); require(p,"profile_sha256"); require(p,"implementation_commit"); require(p,"runtime_registry_sha256");
        ...
        if (!p.getProperty("gate4_contract_sha256").matches("[0-9a-fA-F]{64}") || !p.getProperty("profile_sha256").matches("[0-9a-fA-F]{64}") || !p.getProperty("runtime_registry_sha256").matches("[0-9a-fA-F]{64}")) throw new IllegalStateException("invalid-hash");
    }
