...
public final class RuntimeProfile {
    ...
    private static String[] defaultProotArguments(){return new String[]{"-0","-r","{RUNTIME_ROOT}","-b","/dev","-b","/proc","-b","/sys","-w","/root","/usr/bin/env","-i","HOME=/root","PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin","TERM=xterm-256color","PS1={PROMPT}","{SHELL}","-i"};}
