...
/** Owns the Android process lifetime for explicitly started interactive runtime sessions. */
public final class RuntimeKeepAliveService extends Service {
    ...
    @Override public void onDestroy(){ active=false; List<RuntimeSessionManager> current=owners(); owners.clear(); for(RuntimeSessionManager manager:current) if(manager!=null) manager.finishForKeepAliveStop(); super.onDestroy(); }
