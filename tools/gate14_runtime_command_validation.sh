...
[ -f "$INPUT" ] || blocked 'Gate 13 artifact disappeared'
...
TMP="$OUTPUT.partial.$$"
{
 ...
 printf '%s\n' 'gate13_request_sha256='$INPUT_HASH
 printf '%s\n' 'gate13_artifact='$INPUT
 ...
 printf '%s\n' 'validation_reason=exact POSIX pwd request validated from current Gate 13 provenance; execution remains deferred to G17'
